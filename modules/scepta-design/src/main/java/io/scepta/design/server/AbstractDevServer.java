...
public abstract class AbstractDevServer implements DevServer {
    ...
    protected abstract String doGetResourceDefinition(String org, String group, String tag, String policy, String resource);
    ...
    protected abstract void doSetResourceDefinition(String org, String group, String policy, String resource, String definition);
